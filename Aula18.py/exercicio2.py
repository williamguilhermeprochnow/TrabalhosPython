...
print(f'{lista[1][2]} e {lista[1][4]}, {lista[2][4]} e {lista[2][2]}, {lista[3][1]}, {lista[3][4]} e {lista[3][5]}')
...
print(f'{lista[0][1]}: 5 maço de {lista[2][5]} - 4 pés de {lista[2][0]} e {lista[2][1]}')

print('9: imprima com f-string a seguinte sequência: legumes: 1kg de feijão, 2kg de gão de bico, 1.5 kg dde soja,'
      '1 pacote de ervilha')

print(f'{lista[0][2]}: 1kg de {lista[3][1]} - 2kg de {lista[3][5]} - 1.5kg de {lista[3][6]} - 1 pacote de {lista[3][1]}')
